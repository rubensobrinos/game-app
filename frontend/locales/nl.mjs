...
export const nl = Object.freeze({
  ...
  'lobby.questionTime': 'Tijd per vraag',
  'lobby.questionTime_calm': 'Rustig',
  'lobby.questionTime_normal': 'Normaal',
  'lobby.questionTime_fast': 'Snel',
  ...
  'lobby.game_capitals': 'Hoofdsteden',
  'lobby.game_capitals_desc': 'Wat is de hoofdstad van dit land?',
  'lobby.game_higherlower': 'Hoger of lager',
  'lobby.game_higherlower_desc': 'Twee landen — welk heeft er meer?',
