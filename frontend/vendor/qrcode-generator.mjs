// GEVENDORDE DEPENDENCY — frontend/vendor/ (goedgekeurd in UI1-multiplayer-ui.md §Technische kaders)
// Pakket:   qrcode-generator 2.0.4 (dist/qrcode.mjs, officiele ESM-build)
// Auteur:   Kazuhiko Arase — https://github.com/kazuhikoarase/qrcode-generator
// Licentie: MIT (zie header hieronder); 'QR Code' is een merk van DENSO WAVE.
// Opgehaald: 2 aug 2026 via npm pack, ongewijzigd overgenomen.
// Gebruik via de wrapper frontend/js/qr.mjs — niet rechtstreeks importeren.
