# Review — deployment- en testingplan plus DT0
...
**Voorstel:** verifieer DT0 alleen op map-/placeholderbestaan. Gebruik vanaf DT1
...
### 4. Hoog — DT1 mengt contract-, integratie- en gedragstests
...
**Voorstel:** beperk DT1 tot statische vorm, enums en verboden velden op fixtures én
...
**Voorstel:** maak DT1 eerst een traceability-matrix van gedocumenteerd payloadveld
...
### 7. Middel — DT4 overschat wat Playwright zelfstandig kan bewijzen
...
**Voorstel:** splits DT4 in automatiseerbare browser-E2E en een expliciete echte-
...
### 8. Middel — DT5 kan niet alle L0/L1-criteria alleen in k6 bewijzen
...
daarmee niet automatisch uitgevoerd. DT7 behandelt CI pas als laatste fase, zodat DT1–DT3
lang groen kunnen zijn zonder CI-borging.

**Voorstel:** documenteer al bij DT0/DT1 het lokale canonieke testcommando en de huidige
...
- Een lokale Compose-restart is weliswaar geen productieactie, maar verandert externe
  proces- en datastate. DT6 moet installatie, opstarten, resetten en restartervaring
...
Maak DT0 runnerneutraal: alleen bevestigde mappen met placeholders die niet als groene
tests meetellen, binnen maximaal vijf bestanden. Corrigeer het verificatiecommando en
documenteer de CI-kloof. Splits daarna DT1 strikt in statisch contractbewijs versus
integratiegedrag en laat de contracteigenaren de afgeleide vormen bevestigen. Werk voor
DT4–DT6 per criterium uit welke runner, omgeving en goedkeuring daadwerkelijk bewijs kan
leveren.
