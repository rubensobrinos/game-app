...
**Bijgewerkt:** 3 augustus 2026 · commit `25e66a2`
...
| Niveau | 0 | 1 | 2 | 3 | ⏸ |
|---|---|---|---|---|---|
| Fundamenten | 0 | 2 | 4 | 0 | 2 |
| Componenten | 0 | 5 | 7 | 0 | 0 |
...
De vijf componenten en twee fundamenten op niveau 1 zijn allemaal zelf te
trekken; drie ervan hebben een ticket dat klaarligt (`T2-6` leaderboard-rij,
`T2-9` overlays, `T2-10` typografie, `T2-11` lege en foutstaten).
...
generieke donkere gaming-esthetiek**, hoe netjes elk scherm ook wordt. Elk
component hier kan op 2 staan en dat blijft waar.

De volgorde binnen dit gebied volgt niet het niveau maar wie erop wacht.
Gebouwd in die volgorde: motion-tokens (gebied 3 stond stil), kleurtokens
(gebied 1, 3 en 4), laadvariant (gebied 1 en 4), timer en spelerchip (gebied
1). Wat rest blokkeert alleen gebied 1 nog.
