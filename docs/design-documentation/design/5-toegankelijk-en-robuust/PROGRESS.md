...
| Host verliest verbinding | 1 | gelezen | Pauzereden `host_disconnected` bestaat en wordt getoond. Overdracht of nette beëindiging is nog een open besluit. Prompt: [`prompts/T5-10-host-verliest-verbinding.md`](prompts/T5-10-host-verliest-verbinding.md) — gescoped: recovery/timeout/uitslagbehoud kan onderzocht en gebouwd worden, VIP-overdracht blijft expliciet buiten scope (open PO-besluit, niet zelf ingevuld). |
