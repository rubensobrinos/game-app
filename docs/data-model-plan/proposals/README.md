...
| [`observatie-eventcontract-vs-designdocumentatie.md`](observatie-eventcontract-vs-designdocumentatie.md) | Vergelijking van DM8's eventcontract met de events genoemd in `docs/archief/plandocumentatie/design-documentation/`; geen herzien voorstel, input voor de volgende DM8-reviewronde. |
