...
| [`GF7-teams-and-spectator.md`](GF7-teams-and-spectator.md) | GF7 | ❌ Vervallen (DECISIONS.md #8/#9/#33) — blijft alleen historisch ontwerpvoorstel |
| [`GF8-protocol-interface-proposal.md`](GF8-protocol-interface-proposal.md) | GF8 | ✅ Beantwoord — zie `docs/multiplayer/DECISIONS.md` |
...
GF0–GF6 en GF9–GF11 zijn gebouwd, herzien op `docs/multiplayer/DECISIONS.md` en
geverifieerd (**231/231 tests groen** in `client/flow/`, 10 modules). GF7 wordt niet
uitgevoerd: teams en spectators zijn uit de huidige scope gehaald. GF8 is beantwoord
via [`../protocol-interface-proposal.md`](../protocol-interface-proposal.md) →
`docs/multiplayer/DECISIONS.md`. Zie [`../GF-PROGRESS.md`](../GF-PROGRESS.md) voor de
volledige stand en [`../GF-HANDOFF-TO-INT-A.md`](../GF-HANDOFF-TO-INT-A.md) voor de
overdracht naar UI-aansluiting.
